...
public class ModMaterials {
	...
	public static void preInit() {
		...
		if (ConfigOptions.materialIsAllowed("constantan")) {
		...
		if (ConfigOptions.materialIsAllowed("magicalwood")) {
		...
		if (ConfigOptions.materialIsAllowed("enchantedmetal")) {
		...
		if (ConfigOptions.materialIsAllowed("mica")) {
